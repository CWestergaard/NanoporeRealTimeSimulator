...
parser.add_argument('-oldGuppy', type=str, dest='oldGuppy', 
                    help='If old Guppy version is used for basecalling, resulting in a different header with the timestamp in position 5 (0-based index), use -oldGuppy yes', required=False)
...
# Difference in header between headers in Guppy versions. 
